...
class PentagonalNumber:
    def __init__(self, n: int = None, P_n=None) -> None:
        ...
        self.n = n \
            if n is not None \
            else PentagonalNumber.get_n_of_pentagonal_number(PentagonalNumber(P_n=P_n))
...
class Solution:
    ...
    def __eq__(self, other_solution: Solution) -> bool:
        return (
            (self.P_j == other_solution.P_k and self.P_k == other_solution.P_j) or
            (self.P_j == other_solution.P_j and self.P_k == other_solution.P_k)
